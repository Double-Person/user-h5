	...
	<view class="bindWeixin">
		...
		<view class="bindWeixin-content">
			<view class="bindWeixin-content-item">
				<text>姓名</text>
				<input type="text" value="" placeholder-style="color:#999;fontSize:28rpx;" v-model="username" placeholder="请输入姓名，实名不一致将导致提现失败" />
			</view>
			<view class="bindWeixin-content-item">
				<text>微信账号</text>
				<input type="text" value="" placeholder-style="color:#999;fontSize:28rpx;" v-model="wx" placeholder="请输入微信号" />
			</view>
			<view class="bindWeixin-content-item">
				<text>手机号</text>
