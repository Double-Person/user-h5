<template>
	<view class="changePhone">
		<!-- header -->
		<commonHeader headerTitl="找回密码" xingHide=true lingHide=true fenxiangHide=true></commonHeader>
		...
		<input type="password" :value="pwd" placeholder="设置6位数登录密码" @input="setpwd" maxlength="6"/>
